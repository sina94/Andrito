...
public class ChampionSpellDto {
    ...
    private ArrayList<ImageDto> cost;
    ...
    public ArrayList<ImageDto> getAltimages() {
        return altimages;
    }

    public void setAltimages(ArrayList<ImageDto> altimages) {
    ...
    public ArrayList<ImageDto> getCost() {
        return cost;
    }

    public void setCost(ArrayList<ImageDto> cost) {
        this.cost = cost;
    }
    ...
    public ArrayList<ArrayList<Double>> getEffect() {
        return effect;
    }

    public void setEffect(ArrayList<ArrayList<Double>> effect) {
        this.effect = effect;
    }
