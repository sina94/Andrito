...
public class Participant {
    ...
    private String highestAchievedSeasonTier; // Highest ranked tier achieved for the previous season,
                                              // if any, otherwise null. Used to display border in
                                              // game loading screen.
                                              // (Legal values: CHALLENGER, MASTER, DIAMOND,
    ...
    private int teamId;
    private ParticipantTimeline timeline; //Timeline data. Delta fields refer to values for the specified period
    ...
    // (e.g., the gold per minute over the first 10 minutes of the game versus
                                  // the second 20 minutes of the game. Diffs fields refer to the deltas versus the calculated lane opponent(s).
}
