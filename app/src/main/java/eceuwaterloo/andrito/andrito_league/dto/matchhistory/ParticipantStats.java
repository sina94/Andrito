...
public class ParticipantStats {
    ...
    private long combatPlayerScor; // If game was a dominion game, player's combat score, otherwise 0
    private long deaths;
    ...
    public long getCombatPlayerScor() {
        return combatPlayerScor;
    }

    public void setCombatPlayerScor(long combatPlayerScor) {
        this.combatPlayerScor = combatPlayerScor;
    }
