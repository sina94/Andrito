...
public class ItemDto {
    ...
    private GoldDto gold; // Data Dragon includes the gold field for basic data, which is shared by
                          // both rune and item. However, only items have a gold field on them,
                          // representing their gold cost in the store. Since runes are not sold in
                          // the store, they have no gold cost.
